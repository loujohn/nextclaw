...
import {
  type DingTalkAccountRecord, type RawRecord,
  type DingTalkAccountView, type DingTalkChannelView,
  type DingTalkAccountUpdate, type DingTalkChannelUpdate,
  type DingTalkGroupBindingView, type DingTalkEmployeeBindingsView,
  type EmployeeDingTalkBindingView, type EmployeeDingTalkBindingUpdate,
  DINGTALK_INTEGRATION_TYPE, DINGTALK_INTEGRATION_NAME,
  isRecord, normalizeString, normalizeStringList, normalizeGroups,
  normalizeDmPolicy, normalizeGroupPolicy,
  normalizeAccountRecord, readNormalizedAccounts, readDingTalkChannel, createLegacyAccount,
  isDingTalkBinding, parseAllowedEmployeeCodes
} from "./dingtalk-config-helpers";

export type {
  DingTalkAccountView, DingTalkChannelView,
  DingTalkAccountUpdate, DingTalkChannelUpdate,
  DingTalkGroupBindingView, DingTalkEmployeeBindingsView,
  EmployeeDingTalkBindingView, EmployeeDingTalkBindingUpdate
};
...
function buildDingTalkRuntimeChannel(rawChannel: RawRecord | undefined): Config["channels"]["dingtalk"] {
  ...
  const defaultAccountId = normalized.defaultAccountId;
