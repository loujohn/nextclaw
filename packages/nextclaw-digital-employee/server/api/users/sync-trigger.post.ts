...
import { startUserSyncJob } from "../../services/user-sync-job-manager";
import { hasPersonnelSyncConfig } from "../../services/user-sync-service";
...
export default defineEventHandler(async (event) => {
  ...
  return { ok: true, data: startUserSyncJob(ctx.db) };
});