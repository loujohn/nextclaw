export const FIELD_HELP: Record<string, string> = {
  ...
  "channels.dingtalk.robotCode": "DingTalk robot code used for proactive sends and group replies.",
  "channels.dingtalk.corpId": "DingTalk corp id for organization-scoped APIs.",
  "channels.dingtalk.agentId": "DingTalk app agent id.",
  "channels.dingtalk.allowFrom": "Legacy allowlist for the default DingTalk account.",
  "channels.dingtalk.dmPolicy": "DM policy for legacy/default DingTalk account (pairing/allowlist/open/disabled).",
  "channels.dingtalk.groupPolicy": "Group policy for legacy/default DingTalk account (open/allowlist/disabled).",
  "channels.dingtalk.groupAllowFrom": "Group allowlist for legacy/default DingTalk account.",
  "channels.dingtalk.requireMention": "Whether group messages require a mention by default.",
  "channels.dingtalk.mentionPatterns": "Regex/plain mention patterns accepted in DingTalk groups.",
  "channels.dingtalk.groups": "Per-group mention overrides for the legacy/default DingTalk account.",
  "channels.dingtalk.defaultAccountId": "Default logical DingTalk account id.",
  "channels.dingtalk.accounts": "Multi-account DingTalk config keyed by logical account id.",
  "channels.dingtalk.accounts.*.clientId": "DingTalk client ID for this account.",
  "channels.dingtalk.accounts.*.clientSecret": "DingTalk client secret for this account.",
  "channels.dingtalk.accounts.*.robotCode": "Robot code for this DingTalk account.",
  "channels.dingtalk.accounts.*.corpId": "Corp id for this DingTalk account.",
  "channels.dingtalk.accounts.*.agentId": "Agent id for this DingTalk account.",
  "channels.dingtalk.accounts.*.allowFrom": "Direct-message allowlist for this DingTalk account.",
  "channels.dingtalk.accounts.*.dmPolicy": "DM policy for this DingTalk account.",
  "channels.dingtalk.accounts.*.groupPolicy": "Group policy for this DingTalk account.",
  "channels.dingtalk.accounts.*.groupAllowFrom": "Group allowlist for this DingTalk account.",
  "channels.dingtalk.accounts.*.requireMention": "Whether group messages require mention for this account by default.",
  "channels.dingtalk.accounts.*.mentionPatterns": "Regex/plain mention patterns accepted for this account.",
  "channels.dingtalk.accounts.*.groups": "Per-group overrides for this DingTalk account.",
