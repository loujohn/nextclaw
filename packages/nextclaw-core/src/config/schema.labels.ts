export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.dingtalk.robotCode": "Robot Code",
  "channels.dingtalk.corpId": "Corp ID",
  "channels.dingtalk.agentId": "Agent ID",
  "channels.dingtalk.dmPolicy": "DM Policy",
  "channels.dingtalk.groupPolicy": "Group Policy",
  "channels.dingtalk.groupAllowFrom": "Group Allow From",
  "channels.dingtalk.requireMention": "Require Mention",
  "channels.dingtalk.mentionPatterns": "Mention Patterns",
  "channels.dingtalk.groups": "Group Rules",
  "channels.dingtalk.defaultAccountId": "Default Account ID",
  "channels.dingtalk.accounts": "Accounts",
  "channels.dingtalk.accounts.*.clientId": "Client ID",
  "channels.dingtalk.accounts.*.clientSecret": "Client Secret",
  "channels.dingtalk.accounts.*.robotCode": "Robot Code",
  "channels.dingtalk.accounts.*.corpId": "Corp ID",
  "channels.dingtalk.accounts.*.agentId": "Agent ID",
  "channels.dingtalk.accounts.*.allowFrom": "Allow From",
  "channels.dingtalk.accounts.*.dmPolicy": "DM Policy",
  "channels.dingtalk.accounts.*.groupPolicy": "Group Policy",
  "channels.dingtalk.accounts.*.groupAllowFrom": "Group Allow From",
  "channels.dingtalk.accounts.*.requireMention": "Require Mention",
  "channels.dingtalk.accounts.*.mentionPatterns": "Mention Patterns",
  "channels.dingtalk.accounts.*.groups": "Group Rules",
