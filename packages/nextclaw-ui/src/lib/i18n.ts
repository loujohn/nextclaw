...
export const LABELS: Record<string, { zh: string; en: string }> = {
  ...
  cronLastStatusOk: { zh: '成功', en: 'Success' },
  cronLastStatusError: { zh: '失败', en: 'Failed' },
  cronLastStatusSkipped: { zh: '已跳过', en: 'Skipped' },
  cronErrorConnection: { zh: '连接错误', en: 'Connection error' },
  cronErrorNetwork: { zh: '网络错误', en: 'Network error' },
  cronErrorTimeout: { zh: '请求超时', en: 'Request timeout' },
  cronErrorFetchFailed: { zh: '请求失败', en: 'Fetch failed' },
  heartbeatOk: { zh: '心跳正常', en: 'Heartbeat OK' },
